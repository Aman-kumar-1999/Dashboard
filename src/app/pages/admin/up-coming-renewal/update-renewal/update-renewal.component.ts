...
@Component({
  ...
  styleUrls: ['./update-renewal.component.css']
})
export class UpdateRenewalComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.renewaldata.dueDate=this._routr.snapshot.params['dueDate'];
    this.renewaldata.infoUpdatedBy=this._routr.snapshot.params['infoUpdatedBy'];
    ...
    // alert(this.renewaldata.applicationInfra);
