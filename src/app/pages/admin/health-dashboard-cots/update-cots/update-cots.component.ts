...
import { HealthDashboardUpdataData, HealthDashboardUpdataDatas } from './HealthDashboardUpdateData';

@Component({
  selector: 'app-update-cots',
  templateUrl: './update-cots.component.html',
  styleUrls: ['./update-cots.component.css']
})
export class UpdateCotsComponent implements OnInit {
